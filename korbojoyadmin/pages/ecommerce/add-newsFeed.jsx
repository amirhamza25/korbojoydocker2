        ...
        <div className="card card-statistics">
          <div className="card-header">
            <div className="card-heading">
              <h4 className="card-title">Add AddNewsFeed</h4>
            </div>
          </div>
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  <div className="form-group">
                    ...
                    <div className="mb-2">
                      <input multiple type="file" className="form-control" name="imgs" />
                    </div>
                  </div>
                </div>
                ...
                <div className="col-md-6">
                  <div className="form-group">
                    ...
                    <div className="mb-2">
                      <input type="text" className="form-control" name="shortDiscriptions" onChange={changeStateUpdateHandler} placeholder="date" />
                    </div>
                  </div>
                </div>
              </div>
