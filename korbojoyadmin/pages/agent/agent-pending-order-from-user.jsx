...
import { storeAgentProcessListOfProduct } from "../../atom/listOfAgentAtom";
...
const AgentPendingOrderFromUser = (props) => {
  ...
  const updateNextAtom = useSetRecoilState(storeAgentProcessListOfProduct);
        ...
        <div className="col-md-12 m-b-30">
          <div className="d-block d-sm-flex flex-nowrap align-items-center">
            <div className="page-title mb-2 mb-sm-0">
              <h1>List of daily pending order</h1>
            </div>
